...
describe('M3 Theme Configuration', () => {
  describe('Theme Colors', () => {
    ...
    it('should have lighter Indigo for dark mode', () => {
      expect(themeColors.primary.dark).toBe('#818CF8');
    });
  ...
  describe('Theme Object', () => {
    it('should be a valid MUI theme object', () => {
      // MUI v6 themes have palette defined
      expect(theme.palette).toBeDefined();
    });

    it('should have both light and dark color schemes', () => {
  ...
  describe('M3 Typography Scale', () => {
    it('should have correct h1 (Display Large equivalent)', () => {
      expect(theme.typography.h1.fontSize).toBe('57px');
      expect(theme.typography.h1.lineHeight).toBe('64px');
    });

    it('should have correct body1 (Body Large equivalent)', () => {
      expect(theme.typography.body1.fontSize).toBe('16px');
      expect(theme.typography.body1.lineHeight).toBe('24px');
    });
  ...
  describe('Component Overrides', () => {
    ...
    it('should have rounded cards', () => {
      const cardOverride = theme.components?.MuiCard?.styleOverrides?.root;
    ...
    it('should have M3 dialog corner radius', () => {
      const dialogOverride = theme.components?.MuiDialog?.styleOverrides?.paper;
