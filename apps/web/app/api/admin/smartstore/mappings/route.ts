/**
 * SmartStore Product Mappings API
 *
 * GET  /api/admin/smartstore/mappings - List all mappings
 * POST /api/admin/smartstore/mappings - Create new mapping
 * PATCH /api/admin/smartstore/mappings - Update mapping
 * DELETE /api/admin/smartstore/mappings?id=xxx - Delete mapping
 */
